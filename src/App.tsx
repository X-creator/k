...
import { SnippetNewsSchema } from "lib/schema.ts";

export function App() {
  return (
    <div
      style={{
        background: "linear-gradient(135deg, #28294f 0%, transparent 40%)",
      }}
    >
      <ArticleCard data={SnippetNewsSchema.parse(data[0])}></ArticleCard>
    </div>
  );
}
...
const data = [
  {
    ...
    AB:
      "Mobile bankers left vulnerable: 47% of UK consumers manage finances on insecure" +
